...
$json_string = file_get_contents('shuju.json');
...
if($id==1){
	...
	$url2=$data['data'][0]['url2'];
	$url3=$data['data'][0]['url3'];
	$biao=$data['data'][0]['biao'];
	...
	$url1=$data['data'][1]['url1'];
	$url2=$data['data'][1]['url2'];
	$url3=$data['data'][1]['url3'];
	$biao=$data['data'][1]['biao'];
	$content=$data['data'][1]['content'];
	
}elseif($id==3){
	
	$title=$data['data'][2]['title'];
	$url1=$data['data'][2]['url1'];
	$url2=$data['data'][2]['url2'];
	$url3=$data['data'][2]['url3'];
	$biao=$data['data'][2]['biao'];
    ...
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container py-lg-5 py-md-4">
            <div class="banner-info-grid px-md-5">
                <h2 class="w3l-title-breadcrumb mb-3">Models</h2>
                <p class="inner-page-para px-lg-5">This X3D model of the coke can has been created in 3ds Max, exported to VRML97 and converted, using the instantreality transcoders, to X3D for display online.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="content-info-in row">
                <div class="content-gd col-lg-6 pe-lg-5">
                    <div id="luyou1" style="width:600px;margin:0 auto;background:#cccccc;height:600px;margin-top:30px;">
                   <div id="container">
                    <x3d width="600px" height="600px">
                      <scene>
                         <inline url="x3ds/<?php echo $url1;?>"></inline>
                      </scene>
                    </x3d>
                    </div>
				 </div>   
                ...
                <div class="content-gd col-lg-6 mt-lg-0 mt-5 align-self ps-lg-5">
                    ...
                    <h3 class="w3l-title-main mb-lg-4 mb-3"><?php echo $biao;?></h3>
                    <p class="my-4 pe-lg-5"><?php echo $content;?></p>
